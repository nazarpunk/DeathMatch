...
//var diagram_parts = makeParts(); //fuck
//var diagram_angles = makeAngles(); //fuck
//var diagram_spacing = makeSpacing(); //fuck
//var diagram_axes = makeGridComparison(); //fuck
...
//var neighbors_cube = makeNeighbors("#neighbors-cube", "#neighbors-cube-code"); //fuck
//var neighbors_axial = makeNeighbors("#neighbors-axial", "#neighbors-axial-code", Grid.cubeToTwoAxis, ""); //fuck
...
//var diagram_rotation = makeRotation(); //fuck
//var diagram_rings = makeSpiral("diagram-rings", false); //fuck
//var diagram_spiral = makeSpiral("diagram-spiral", true); //fuck
...
function orient(orientation) {
    //diagram_parts(orientation); //fuck
    //diagram_angles(orientation); //fuck
    //diagram_spacing(orientation); //fuck
    //diagram_axes(orientation); //fuck
    
    //grid_cube.update(65, orientation); //fuck
    //grid_axial.update(65, orientation); //fuck

    //neighbors_cube.update(100, orientation); //fuck
    //neighbors_axial.update(100, orientation); //fuck
    //neighbors_diagonal.update(75, orientation); //fuck

    diagram_distances.update(60, orientation);
    diagram_lines.update(45, orientation);
    diagram_fov.update(35, orientation);
    //diagram_rotation.update(60, orientation); //fuck
